...
Register-ScheduledTask -TaskName $reconcileTaskName -Action $reconcileAction -Trigger $reconcileTrigger -Settings $settings -Description "Reconciles ProVide source roots and STOR logs into transfer queue jobs." -Force | Out-Null
